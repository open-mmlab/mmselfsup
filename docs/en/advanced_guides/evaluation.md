...
- [Evaluation](#evaluation)
  - [Extract Backbone](#extract-backbone)
...
```shell
python ./tools/model_converters/extract_backbone_weights.py epoch_100.pth epoch_100_backbone.pth
```

## Classification

As for classification, we provide scripts in folder `tools/benchmarks/classification/`, which has 2 `.sh` files, 1 folder for VOC SVM related classification task and 1 folder for ImageNet nearest-neighbor classification task.
...
sh tools/benchmarks/classification/svm_voc07/slurm_test_svm_epoch.sh mm_model svm configs/benchmarks/classification/imagenet/resnet50_linear-8xb512-coslr-90e_in1k.py 100 "feat5"
```
...
```shell
# distributed version
sh tools/benchmarks/classification/mim_dist_train.sh ${CONFIG} ${PRETRAIN}

# slurm version
sh tools/benchmarks/classification/mim_slurm_train.sh ${PARTITION} ${CONFIG} ${PRETRAIN}
...
```shell
sh tools/benchmarks/classification/mim_slurm_train.sh mm_model configs/benchmarks/classification/imagenet/resnet50_linear-8xb512-coslr-90e_in1k.py work_dirs/selfsup/simsiam_resnet50_8xb32-coslr-100e_in1k/epoch_100.pth --work-dir work_dirs/benchmarks/simsiam/
```
...
```shell
sh tools/benchmarks/classification/mim_slurm_train.sh mm_model configs/benchmarks/classification/imagenet/imagenet_10percent/resnet50_head1_4xb64-steplr1e-1-20e_in1k-10pct.py work_dirs/selfsup/simsiam_resnet50_8xb32-coslr-100e_in1k/epoch_100.pth --work-dir work_dirs/benchmarks/simsiam/
```
