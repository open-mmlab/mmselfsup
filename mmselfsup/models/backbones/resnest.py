...
class SplitAttentionConv2d(nn.Module):
    ...
    Args:
        inplanes (int): Same as nn.Conv2d.
        planes (int): Same as nn.Conv2d.
    ...
    def __init__(self,
        ...
        inter_channels = max(inplanes * radix // reduction_factor, 32)
        self.radix = radix
        self.groups = groups
        ...
        self.norm0_name, norm0 = build_norm_layer(
            norm_cfg, planes * radix, postfix=0)
        self.add_module(self.norm0_name, norm0)
        self.relu = nn.ReLU(inplace=True)
        self.fc1 = build_conv_layer(
            None, planes, inter_channels, 1, groups=self.groups)
        self.norm1_name, norm1 = build_norm_layer(
            norm_cfg, inter_channels, postfix=1)
        self.add_module(self.norm1_name, norm1)
        self.fc2 = build_conv_layer(
            None, inter_channels, planes * radix, 1, groups=self.groups)
