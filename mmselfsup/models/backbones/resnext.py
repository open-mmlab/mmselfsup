...
class Bottleneck(_Bottleneck):
    ...
    def __init__(self,
                 ...
                 width_per_group=4,
                 **kwargs):
        """Bottleneck block for ResNeXt. If style is "pytorch", the stride-two
        ...
        """
        super(Bottleneck, self).__init__(inplanes, planes, stride, **kwargs)

        if groups == 1:
            width = self.planes
        else:
            width = math.floor(self.planes * (width_per_group / 64)) * groups
